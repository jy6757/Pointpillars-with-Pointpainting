...
from utils import bbox3d2bevcorners, box_collision_test, read_points, remove_pts_in_bboxes, limit_period
...
def dbsample(CLASSES, data_root, data_dict, db_sampler, sample_groups):
    ...
    for name, v in sample_groups.items(): # name : class name, v : class number
