...
from torch.utils.tensorboard import SummaryWriter  # numpy version = 1.23.5
...
def main(args):
    ...
    if not args.no_cuda:
        pointpillars = PointPillars(nclasses=args.nclasses, in_channel = in_channel).cuda()
    else:
        pointpillars = PointPillars(nclasses=args.nclasses, in_channel = in_channel)
